...
<div
          ...
          ></div>
            ...
            <Image src={'/icons/reflow.png'} className="absolute rounded-full lg:bottom-[77px] lg:p-4 p-0.5   lg:right-0 lg:w-[74px] w-[26px] h-[28px] lg:h-[76px] bottom-[-7px] right-[62px]  flex items-center justify-center" alt="paguesafe" width={73} height={76} />
            ...
            <Image src={'/icons/paguesafe.png'} className="absolute top-[147px] lg:top-[97px] rounded-sm right-[2px] lg:right-0 flex  lg:w-[74px] w-[28px] h-[30px] lg:h-[76px] items-center justify-center" alt="azcend" width={73} height={76}/>
