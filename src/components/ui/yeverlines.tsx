...
<div
          ...
          ></div>
            ...
            <Image src={'/icons/expay.png'} className="absolute top-[145px] lg:top-[97px] rounded-sm right-[2px] lg:right-0 flex  lg:w-[74px] w-[28px] h-[30px] lg:h-[76px] items-center justify-center" alt="expay" width={73} height={76}/>
