...
export default function Garantia() {    
    return (
        <>
        <div style={{backgroundColor: '#1F073B'}} className="px-4 relative flex flex-col jusitfy-center items-center sm:px-6 lg:px-8 py-12 pt-44 mt-12">
            <div className="max-w-7xl mx-auto">
                <div className="flex items-center gap-8">
                    <div className="hidden  lg:block">
                        <img width={300} className="hover:animate-pulseScale " src="/garantia.svg" alt="Garantia" />
                    </div>
                    ...
                    <div className="flex-1 justify-center">
                        ...
                        <p className="text-base sm:text-lg lg:text-xl xl:text-2xl font-faktum text-white mb-4">
                            Se o Ameii não superar suas expectativas em até 30 dias, prometemos reembolso total, sem burocracia. Sua confiança, nossa prioridade.
                        </p>
